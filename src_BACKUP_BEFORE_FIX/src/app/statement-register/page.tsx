                                        ...
                                        filteredStatements.map((s, index) => (
                                            ...
                                            >
                                                ...
                                                <TableCell className="text-right font-bold text-sm">
                                                    â‚¹{s.creditTotals?.netSale?.toLocaleString() || '0'}
                                                </TableCell>
                                                <TableCell className="text-right font-bold text-sm text-rose-400">
                                                    - â‚¹{s.totalDebit?.toLocaleString() || '0'}
                                                </TableCell>
                                                <TableCell className="text-right">
                                                    <p className={cn(
                                                        ...
                                                        â‚¹{Math.abs(s.finalBalance).toLocaleString()}
                                                    </p>
                            ...
                            <TableFooter className="bg-white/[0.05] h-20 font-black border-t-2 border-white/10">
                                <TableRow className="border-none">
                                    ...
                                    <TableCell className="text-right text-base tracking-tighter">
                                        â‚¹{globalTotals.credits.toLocaleString()}
                                    </TableCell>
                                    <TableCell className="text-right text-base tracking-tighter text-rose-400">
                                        - â‚¹{globalTotals.debits.toLocaleString()}
                                    </TableCell>
                                    <TableCell className="text-right">
                                        <div className="flex flex-col items-end">
                                            <span className={cn(
                                                ...
                                                â‚¹{Math.abs(globalTotals.balance).toLocaleString()}
                                            </span>
