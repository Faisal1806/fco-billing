    ...
    return (
        ...
        >
            ...
            <p className="text-xs font-black text-muted-foreground tracking-[0.5em] uppercase mt-3 opacity-60">
                F.CO BILLING OS â€¢ SECURE SESSION
            </p>
        </motion.div>
    );
};
...
if (!extractedYears.includes(selectedYear)) {
  ...
  const summaryCards = [
    { title: "Today's Yield", value: `â‚¹${stats.todaySales}`, description: `${stats.todayPatti} Patti / ${stats.todayDabba} Dabba transactions finalized today.`, icon: DollarSign },
    { title: "Monthly Index", value: `â‚¹${stats.monthSales}`, description: `Consolidated net revenue performance for the current calendar month.`, icon: TrendingUp },
    { title: "YTD Gross", value: `â‚¹${stats.yearGrossSales}`, description: `Aggregated seasonal gross revenue for the entire ${selectedYear} mandate.`, icon: BarChart },
                        ...
                        {topGrowers.map((grower, i) => (
                            ...
                            >
                                ...
                                <h3 className="text-3xl font-black text-accent drop-shadow-[0_0_30px_rgba(34,197,94,0.5)]">
                                    â‚¹{grower.netSales.toLocaleString()}
                                </h3>
