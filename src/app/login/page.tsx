    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-gray-900 via-gray-800 to-slate-900 p-4">
        ...
        >
            <div className="w-48 h-48 relative">
                <div className="absolute inset-0 bg-purple-400 rounded-full blur-xl"></div>
                <div className="absolute inset-0 bg-purple-400 rounded-full" style={{clipPath: 'path("M 50,0 A 50,50 0 1 1 0,50 A 50,50 0 0 1 50,0 Z M 80,80 Q 95,95 80,110 L 110,80 Z") scale(0.95) translate(2,2)'}}></div>
