...
export const ClassicA4Layout = ({
  ...
  return (
    <div className="invoice-paper relative mx-auto flex h-[208mm] w-[146mm] flex-col overflow-hidden border border-green-700 bg-[#FDFEE2] p-2 font-serif text-black shadow-lg print:shadow-none">
